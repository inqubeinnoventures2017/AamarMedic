...
public class SelectStateDailogBoxAdapter extends RecyclerView.Adapter<SelectStateDailogBoxAdapter.RecyclerViewHolder> {
    ...
    public SelectStateDailogBoxAdapter(List<BaseModelClass> list_items, Activity activity, AllInterfaces.AdapterCallback ad_call) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        holder.tv_select_role.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ad_callback.onReturn(""+list_items.get(position).getSelected()+"-" + position);
            }
        });
